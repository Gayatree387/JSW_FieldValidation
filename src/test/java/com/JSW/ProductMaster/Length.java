...
public class Length extends BaseTest implements JSW_TestData
{
	...
	@Test(priority = 2)
	public void CheckLengthShouldNotMoreThan50ForSAPProductCode()throws InterruptedException
	{
		JSW_MasterModule masterdata = new JSW_MasterModule(driver);
		Thread.sleep(700);
		masterdata.SAPProductCodeLengthMoreThan50Method();
		Thread.sleep(700);
		...
		if(Length > 50)
		{
			...
			AutoConstant.fileone.setCellData(Product_Sheet, "Status", 12, "Fail");
		}
		else
		{
			System.out.println("Pass");
			AutoConstant.fileone.setCellData(Product_Sheet, "Status", 12, "Pass");
		}
	}
