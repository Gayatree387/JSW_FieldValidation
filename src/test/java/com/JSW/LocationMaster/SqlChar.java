...
public class SqlChar extends BaseTest implements JSW_TestData
{
	...
	@Test(priority = 2)
	public void CkeckSqlCharForLocationName()throws InterruptedException
	{
		JSW_MinesMasterModule masterdata = new JSW_MinesMasterModule(driver);
		Thread.sleep(700);
		masterdata.LocationNameSqlCharMethod();
		Thread.sleep(700);
		...
		if (constainsSpecial == true) {
			AutoConstant.fileone.setCellData(LocationMaster_Sheet, "Status", 7, "Fail");
			System.out.println("Fail");
		} 
		else {
			AutoConstant.fileone.setCellData(LocationMaster_Sheet, "Status", 7, "Pass");
